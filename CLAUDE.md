...
**MedInventory v1.3.3** (Custode_v2) — Italian-language web application for managing medical devices (*apparecchi elettromedicali*) in healthcare facilities. Built for Windows LAN deployment by Studio Bergamaschi.
