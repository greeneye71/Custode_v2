...
CREATE INDEX IF NOT EXISTS idx_impianti_componenti_impianto ON impianti_componenti(impianto_id);
...
CREATE INDEX IF NOT EXISTS idx_impianti_documenti_impianto ON impianti_documenti(impianto_id);
CREATE INDEX IF NOT EXISTS idx_impianti_documenti_tipo ON impianti_documenti(tipo);
...
CREATE INDEX IF NOT EXISTS idx_impianti_scadenze_impianto ON impianti_scadenze(impianto_id);
CREATE INDEX IF NOT EXISTS idx_impianti_scadenze_prossima ON impianti_scadenze(prossima_scadenza);
CREATE INDEX IF NOT EXISTS idx_impianti_scadenze_attiva ON impianti_scadenze(attiva);
...
CREATE INDEX IF NOT EXISTS idx_impianti_interventi_impianto ON impianti_interventi(impianto_id);
CREATE INDEX IF NOT EXISTS idx_impianti_interventi_scadenza ON impianti_interventi(scadenza_id);
CREATE INDEX IF NOT EXISTS idx_impianti_interventi_data ON impianti_interventi(data_intervento);
...
CREATE INDEX IF NOT EXISTS idx_impianti_avvisi_scadenza ON impianti_avvisi_inviati(scadenza_id);

-- La vista si ricrea a ogni avvio in apply_schema_updates(): cambiarne il
-- corpo in un rilascio successivo non richiede altro che modificare quelle
-- righe (qui e in models.py restano allineate).
